  ...
  <body>
     ...
     <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
      ...
      <nav class="my-2 my-md-0 mr-md-3">
        <a class="p-2 text-dark" href="product_main.jsp">Home</a>
        <a class="p-2 text-dark" href="search.jsp">Completed Orders</a>
	   ...
	   <a class="btn btn-outline-primary" href="../Product page/product_main.jsp">Log-out</a>
		...
		Statement st =con.createStatement();
                                 try{
                ResultSet rs = st.executeQuery("Select Orderno,FoodName,price,status from cart where  cid= "+cid);
                               while(rs.next()){
